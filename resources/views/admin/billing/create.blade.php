                    ...
                    <div class="card-block">
                      <div class="row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control" name="billing_no" id="billing_no" value="{{ $billing_no }}" required readonly>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <select class="form-control" name="supplier_id" id="supplier_id" required>
                                ...
                                <option value="{{ $supplier->id }}" @if(old('supplier_id') == $supplier->id) selected @endif>{{ $supplier->title }}</option>
                                @endforeach
                            </select>
