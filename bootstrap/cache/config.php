<?php return array (
  ...
  array (
    ...
    'fallback_locale' => 'en',
    'faker_locale' => 'en_US',
    'key' => 'base64:sbZ1m9m+ztbTDOfVi0rtFilyluSj9dwqbr5OQlfDWQg=',
    'cipher' => 'AES-256-CBC',
    'providers' => 
    array (
  ...
  array (
    ...
    array (
      ...
      array (
        'driver' => 'file',
        'path' => '/opt/lampp/htdocs/Dapin-CMS/storage/framework/cache/data',
      ),
      'memcached' => 
      array (
        'driver' => 'memcached',
...
',
    ...
    'temporary_files' => 
    array (
      'local_path' => '/opt/lampp/htdocs/Dapin-CMS/storage/framework/laravel-excel',
      'remote_disk' => NULL,
      'remote_prefix' => NULL,
  ...
  array (
    ...
    array (
      ...
      array (
        'driver' => 'local',
        'root' => '/opt/lampp/htdocs/Dapin-CMS/storage/app',
      ),
      'public' => 
      array (
        'driver' => 'local',
        'root' => '/opt/lampp/htdocs/Dapin-CMS/storage/app/public',
        'url' => '/storage',
        'visibility' => 'public',
      ),
      's3' => 
  ...
  array (
    ...
    array (
      ...
      array (
        'driver' => 'single',
        'path' => '/opt/lampp/htdocs/Dapin-CMS/storage/logs/laravel.log',
        'level' => 'debug',
      ),
      'daily' => 
      array (
  ...
  array (
    ...
    array (
      ...
      'paths' => 
      array (
        0 => '/opt/lampp/htdocs/Dapin-CMS/resources/views/vendor/mail',
      ),
    ),
    'log_channel' => NULL,
  ),
  ...
  array (
    ...
    'encrypt' => false,
    'files' => '/opt/lampp/htdocs/Dapin-CMS/storage/framework/sessions',
    'connection' => NULL,
    'table' => 'sessions',
    'store' => NULL,
    'lottery' => 
  ...
  array (
    'paths' => 
    array (
      0 => '/opt/lampp/htdocs/Dapin-CMS/resources/views',
    ),
    'compiled' => '/opt/lampp/htdocs/Dapin-CMS/storage/framework/views',
  ),
  'image' => 
  array (
    'driver' => 'gd',
  ...
  array (
    ...
    'view_path' => '/opt/lampp/htdocs/Dapin-CMS/resources/views/livewire',
    'layout' => 'layouts.app',
    'asset_url' => NULL,
    'app_url' => NULL,
  ...
  array (
    ...
    'remote_sites_path' => '/opt/lampp/htdocs/Dapin-CMS',
    'local_sites_path' => '',
