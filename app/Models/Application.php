...
protected $fillable = [
    ...
    'permanent_district', 'permanent_village', 'permanent_address', 'gender', 'dob', 'email', 'phone', 'emergency_phone',
    ...
    'collage_certificate', 'photo', 'signature', 'fee_amount', 'pay_status', 'payment_method', 'status', 
