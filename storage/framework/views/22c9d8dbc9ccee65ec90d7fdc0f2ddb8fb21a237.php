        ...
        <div class="row align-items-center justify-content-center">
            <div class="col-lg-8 text-center text-lg-left">
                <header class="section-title cta-title" data-aos="fade-right" data-aos-duration="1000">
                    <h2 id="cta-title" itemprop="headline" class="text-white fw-bold"><?php echo e($callToAction->title); ?></h2>
                    <p itemprop="text" class="text-light mb-0"><?php echo e($callToAction->sub_title); ?></p>
                </header>
            </div>
            <div class="col-lg-4 text-center text-lg-right mt-3 mt-lg-0">
                <div class="cta-btn s-cta-btn" data-aos="fade-left" data-aos-duration="1000" data-aos-delay="200">
                    ...
                    <a href="<?php echo e($callToAction->button_link); ?>" target="_blank" rel="noopener noreferrer" class="btn ss-btn smoth-scroll" itemprop="url">
                        <?php echo e($callToAction->button_text); ?> <i class="fal fa-long-arrow-right" aria-hidden="true"></i>
                        <span class="sr-only">Go to <?php echo e($callToAction->button_text); ?></span>
                    </a>
                    <?php endif; ?>
                </div>
            </div>
...
<?php endif; ?>
<?php /**PATH C:\wamp64\www\Dapin-CMS-main\resources\views/web/cot.blade.php ENDPATH**/ ?>