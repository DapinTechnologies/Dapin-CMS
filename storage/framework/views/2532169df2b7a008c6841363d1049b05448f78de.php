...
<button class="btn btn-sm btn-warning edit-invoice-btn"
        ...
        data-fee-details="<?php echo e(htmlspecialchars(json_encode($feeDetails), ENT_QUOTES, 'UTF-8')); ?>"
        data-current-categories="<?php echo e(htmlspecialchars(json_encode($currentCategories), ENT_QUOTES, 'UTF-8')); ?>"
        data-assign-date="<?php echo e($invoice->assign_date); ?>"
        data-due-date="<?php echo e($invoice->due_date); ?>"
                    ...
                    <div class="form-group mb-3">
                        ...
                        <select id="available_categories" class="form-control select2">
                            ...
                            <?php $__currentLoopData = $allCategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($category->id); ?>" data-amount="<?php echo e($category->amount); ?>">
                                    <?php echo e($category->title); ?> (<?php echo e(number_format($category->amount, 2)); ?>)
                                </option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
        ...
        <div class="modal-content border-0 shadow-lg">
            ...
            <div class="modal-body p-4">
                ...
                <div class="row g-4 mb-4">
                    ...
                    <div class="col-md-5">
                        <div class="d-flex align-items-center mb-3">
                            <img src="<?php echo e(asset('assets/images/logo.png')); ?>" alt="Logo" style="height: 50px;" class="me-3">
                            <div>
                                <h4 class="mb-0 fw-bold"><?php echo e(config('app.name')); ?></h4>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/Dapin-CMS/resources/views/admin/fees-student/quick-assign.blade.php ENDPATH**/ ?>