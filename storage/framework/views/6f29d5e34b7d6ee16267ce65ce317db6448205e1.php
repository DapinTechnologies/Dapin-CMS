                        ...
                        <div class="form-group col-md-4">
                            ...
                            <select class="form-control select2" name="program" id="program">
                                ...
                                <?php $__currentLoopData = $programs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $program): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($program->id); ?>" <?php if($selected_program == $program->id): ?> selected <?php endif; ?>>
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <select class="form-control select2" name="semester" id="semester">
                                ...
                                <?php $__currentLoopData = $semesters; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $semester): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($semester->id); ?>" <?php if($selected_semester == $semester->id): ?> selected <?php endif; ?>>
            ...
            <div class="col-md-3">
                <div class="card text-center">
                    <div class="card-body">
                        ...
                        <h2 class="text-primary"><?php echo e(count($exam_routines)); ?></h2>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-3">
                <div class="card text-center">
                    <div class="card-body">
                        ...
                        <h2 class="text-success"><?php echo e($overall_pass_rate); ?>%</h2>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-3">
                <div class="card text-center">
                    <div class="card-body">
                        ...
                        <h2 class="text-warning"><?php echo e($total_missing_marks); ?></h2>
                    </div>
                </div>
            </div>
             ...
             <div class="col-md-3">
                <div class="card text-center">
                    <div class="card-body">
                        ...
                        <h2 class="text-warning"><?php echo e($total_missing_cases); ?></h2>
                    </div>
                </div>
            </div>
...
<div class="col-md-6">
    ...
    >
        ...
        Upcoming Exams (<?php echo e(count($exam_routines)); ?>)
    ...
    <div class="collapse" id="examListCollapse">
        <ul class="list-group">
            <?php $__empty_1 = true; $__currentLoopData = $exam_routines; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $exam): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <li class="list-group-item d-flex justify-content-between align-items-center">
                    <?php echo e($exam['title']); ?>

                    <span class="badge bg-primary rounded-pill">
                        <?php echo e(\Carbon\Carbon::parse($exam['start'])->format('M d')); ?>
    ...
    <div class="col-md-6 mt-4">
       ...
       <?php if(isset($program_stats) && count($program_stats) > 0): ?>
    <div class="card">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table id="resultsTable" class="table table-bordered table-striped">
                    ...
                    <tbody>
                        <?php $__currentLoopData = $program_stats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $program): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <td><?php echo e($program['program_name']); ?></td>
                                <td><?php echo e($program['cat1_avg']); ?></td>
                                <td><?php echo e($program['cat2_avg']); ?></td>
                                <td><?php echo e($program['mock_avg']); ?></td>
                                <td><?php echo e($program['passed_students']); ?></td>
                                <td><?php echo e($program['total_students']); ?></td>
                                <td><?php echo e($program['pass_rate']); ?>%</td>
                            </tr>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </tbody>
                    <tfoot>
                        <tr>
                            ...
                            <th><?php echo e($total_passing_students); ?></th>
                            <th><?php echo e($total_students); ?></th>
                            <th><?php echo e($overall_pass_rate); ?>%</th>
                        </tr>
                    </tfoot>
                </table>
            </div>
...
<?php if($missing_marks_students->count() > 0): ?>
<div class="card">
    <div class="card-header d-flex justify-content-between align-items-center">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class="table table-bordered" id="missingMarksTable">
                ...
                <tbody>
                    <?php $__currentLoopData = $missing_marks_students; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $student): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        ...
                        <td><?php echo e($student['semester_name']); ?></td>
                        <td><?php echo e($student['subject_name']); ?> (<?php echo e($student['subject_code']); ?>)</td>
                        <td>
                            <span class="badge badge-<?php echo e($student['status'] == 'No Exams' ? 'warning' : 'danger'); ?>">
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        var calendar = new FullCalendar.Calendar(calendarEl, {
            ...
            events: <?php echo json_encode($exam_routines, 15, 512) ?>
        });
        calendar.render();
    });
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    new Chart(document.getElementById('programPassRateChart'), {
        type: 'bar',
        data: {
            labels: <?php echo json_encode($chart_programs, 15, 512) ?>,
            datasets: [
                {
                    label: 'Pass Rate',
                    data: <?php echo json_encode($chart_pass_rates, 15, 512) ?>,
                    backgroundColor: '#28a745', // Green color for pass rate
                    stack: 'Stack 0'
                },
                {
                    label: 'Fail Rate',
                    data: <?php echo json_encode($chart_fail_rates, 15, 512) ?>, // Calculated as (100 - pass rate)
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\User\Desktop\cms\Dapin-CMS\resources\views/admin/dashboard-repo/index.blade.php ENDPATH**/ ?>