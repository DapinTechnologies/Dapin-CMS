...
<li class="<?php echo e(Request::is('web/admission*') ? 'current' : ''); ?>">
    <a href="<?php echo e(url('admission')); ?>">Admission</a>
</li>
...
<?php /**PATH /opt/lampp/htdocs/Dapin-CMS/resources/views/web/layouts/header.blade.php ENDPATH**/ ?>