    ...
    <div class="page-wrapper">
        <div class="row">
            <div class="col-md-8 offset-md-2">
                <form class="needs-validation" action="<?php echo e(route('admin.materialsupdate', $material->id)); ?>" method="post" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    <div class="card">
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\User\Desktop\cms\Dapin-CMS\resources\views/admin/files/editmaterial.blade.php ENDPATH**/ ?>