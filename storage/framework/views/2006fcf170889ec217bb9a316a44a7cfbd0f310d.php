...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <div>
                <a href="<?php echo e(route($route.'.batch-assign')); ?>" class="btn btn-info btn-sm">
                ...
                <a href="<?php echo e(route($route.'.export')); ?>" class="btn btn-info btn-sm ml-2">
...
<!-- Send Invoice Modal -->
<div class="modal fade" id="sendInvoiceModal-<?php echo e($feeStructure->id); ?>" tabindex="-1" aria-labelledby="sendInvoiceModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header bg-primary text-white">
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/Dapin-CMS/resources/views/admin/fee-structures/index.blade.php ENDPATH**/ ?>