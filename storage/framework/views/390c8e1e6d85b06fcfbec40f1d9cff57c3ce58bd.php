    ...
    <div class="container-fluid">
        <div class="row g-2 align-items-center">
            ...
            <div class="col-auto ms-auto d-print-none">
                <a href="<?php echo e(route($route.'.index')); ?>" class="btn btn-outline-primary">
        ...
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <div class="card border-0 shadow-lg">
                    <form action="<?php echo e(route($route.'.store')); ?>" method="POST" id="paymentForm" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="card-body">
                           <!-- Student Selection -->
                            <div class="form-group mb-4">
                                <label for="student_enroll_id" class="form-label"><?php echo e(__('field_student')); ?> <span class="text-danger">*</span></label>
                                    ...
                                    <select class="form-control select2" name="student_enroll_id" id="student_enroll_id" required>
                                        ...
                                        <?php $__currentLoopData = $students; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $student): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($student->id); ?>"
                                                data-program="<?php echo e($student->program->title ?? 'N/A'); ?>"
                                                data-batch="<?php echo e($student->batch->title ?? 'N/A'); ?>"
                                                data-regno="<?php echo e($student->student->registration_number ?? $student->student->student_id); ?>">
                                                <?php echo e($student->student->student_id ?? $student->student->registration_number); ?> - 
                                                <?php echo e($student->student->first_name); ?> <?php echo e($student->student->last_name); ?>
...
$(document).ready(function() {
    ...
    function loadStudentInvoices(studentEnrollId) {
        ...
        $.ajax({
            url: '<?php echo e(route("admin.payments.getStudentInvoices")); ?>',
            type: 'POST',
            data: {
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\Dapin-CMS-main\resources\views/admin/payments/create.blade.php ENDPATH**/ ?>