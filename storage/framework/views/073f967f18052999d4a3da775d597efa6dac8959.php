                ...
                <div class="col-12">
                    ...
                    <div class="text-center">
                        ...
                        <div class="partners-logos mt-4 d-flex flex-wrap justify-content-center align-items-center gap-4">
                            <img src="<?php echo e(asset('assets/images/partner1.png')); ?>" alt="Partner 1" class="img-fluid" style="max-height: 80px;">
                            <img src="<?php echo e(asset('assets/images/partner2.png')); ?>" alt="Partner 2" class="img-fluid" style="max-height: 80px;">
                            <img src="<?php echo e(asset('assets/images/partner3.png')); ?>" alt="Partner 3" class="img-fluid" style="max-height: 80px;">
                        </div>
                    </div>
                </div>
            </div>
