    ...
    <div class="hidden md:grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div class="course-card">
            <a href="<?php echo e(route('course.single', ['slug' => $course->slug])); ?>" class="text-decoration-none text-dark d-block">
                ...
                <p class="mb-3 text-gray-600"><i class="fas fa-money-bill-wave mr-2 text-blue-500"></i><strong>Fee:</strong> KSH <?php echo e(number_format($course->fee, 2)); ?></p>
                <div class="course-extra mt-3">
                    <p class="text-gray-700 mb-2"><strong>Description:</strong> <?php echo $course->description; ?></p>
            ...
            <div>
                <div class="course-card">
                    <a href="<?php echo e(route('course.single', ['slug' => $course->slug])); ?>" class="text-decoration-none text-dark d-block">
                        ...
                        <p class="mb-3 text-gray-600"><i class="fas fa-money-bill-wave mr-2 text-blue-500"></i><strong>Fee:</strong> KSH <?php echo e(number_format($course->fee, 2)); ?></p>
                        <div class="course-extra mt-3">
                            <p class="text-gray-700 mb-2"><strong>Description:</strong> <?php echo Str::limit($course->description, 150); ?></p>
                            <?php if($course->award): ?><p><strong>Award:</strong> <?php echo e($course->award); ?></p><?php endif; ?>
                            <?php if($course->semesters): ?><p><strong>Semesters:</strong> <?php echo e($course->semesters); ?></p><?php endif; ?>
                        </div>
                    </a>
...
<?php /**PATH /opt/lampp/htdocs/Dapin-CMS/resources/views/web/coursehead.blade.php ENDPATH**/ ?>