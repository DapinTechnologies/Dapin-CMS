      ...
      <div class="modal-body p-4">
        <div class="row">
          <div class="col-md-6 border-right">
            ...
            <form id="inquiryForm" method="POST" action="<?php echo e(route('frontend.inquiry.store')); ?>">
              <?php echo csrf_field(); ?>
          ...
          <div class="col-md-6">
            ...
            <form id="subscribeForm" method="POST" action="<?php echo e(route('frontend.newsletter.store')); ?>">
              <?php echo csrf_field(); ?>
...
</script><?php /**PATH C:\Users\User\Desktop\cms\Dapin-CMS\resources\views/web/enquiry.blade.php ENDPATH**/ ?>