                    ...
                    <div class="card-block">
                        <div class="table-responsive">
                            ...
                            <table class="table table-striped table-bordered datatable">
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $feeCategorySummary; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category => $amount): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                ...
                                <tfoot>
                                    <tr>
                                        <th>Total</th>
                                        <th>KSh <?php echo e(number_format(array_sum($feeCategorySummary), 2)); ?></th>
                                    </tr>
                                </tfoot>
                            </table>
                        </div>
                    ...
                    <div class="card-block">
                        <div class="table-responsive">
                            ...
                            <table class="table table-striped table-bordered datatable">
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $semesterSummary; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $semester => $amount): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                ...
                                <tfoot>
                                    <tr>
                                        <th>Total</th>
                                        <th>KSh <?php echo e(number_format(array_sum($semesterSummary), 2)); ?></th>
                                    </tr>
                                </tfoot>
                            </table>
                        </div>
                ...
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <div class="total-fees">
                            <strong>Total Collected: KSh <?php echo e(number_format($totalAmount, 2)); ?></strong>
                        </div>
                    </div>
                    <div class="card-block">
                        <div class="table-responsive">
                            ...
                            <table class="table table-striped table-bordered datatable">
                                ...
                                <tbody>
                                    ...
                                    ?>
                                    <?php $__currentLoopData = $facultySummary; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $faculty => $amount): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td><?php echo e($faculty); ?></td>
                                        <td>KSh <?php echo e(number_format($amount, 2)); ?></td>
                                        <td><?php echo e($grandTotal > 0 ? number_format(($amount / $grandTotal) * 100, 2) : 0); ?>%</td>
                                    </tr>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </tbody>
                            </table>
                        ...
                        <div class="table-responsive">
                            ...
                            <table class="table table-striped table-bordered datatable">
                                ...
                                <tbody>
                                    ...
                                    ?>
                                    <?php $__currentLoopData = $summaryTable; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td>KSh <?php echo e(number_format($item['collected_amount'], 2)); ?></td>
                                    </tr>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </tbody>
                                <tfoot>
                                    <tr>
                                        ...
                                        <th>KSh <?php echo e(number_format($detailedTotal, 2)); ?></th>
                                    </tr>
                                </tfoot>
                            </table>
                        </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const feeCategories = <?php echo json_encode($feeCategories->pluck('title'), 15, 512) ?>;
    const selectedCategory = <?php echo json_encode($selectedCategoryTitle, 15, 512) ?>;
    ...
    const facultyData = <?php echo json_encode($facultyDistribution, 15, 512) ?>;
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\Dapin-CMS-main\resources\views/admin/fee-collection-report/index.blade.php ENDPATH**/ ?>