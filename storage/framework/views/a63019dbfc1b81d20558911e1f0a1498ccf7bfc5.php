            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $.each(response, function(key, invoice) {
                        $('#invoice_id').append('<option value="'+invoice.id+'">INV-'+invoice.invoice_no+' (Due: <?php echo e(config('app.currency_symbol')); ?>'+invoice.amount_due+')</option>');
                    });
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/Dapin-CMS/resources/views/admin/fees-adjustment/index.blade.php ENDPATH**/ ?>