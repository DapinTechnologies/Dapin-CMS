...
<li class="nav-item pcoded-hasmenu <?php echo e(Request::is('admin/fees*') ? 'pcoded-trigger active' : ''); ?>">
    ...
    <li class="nav-item pcoded-hasmenu <?php echo e(Request::is('admin/fees-student*') ? 'pcoded-trigger active' : ''); ?>">
        ...
        <ul class="pcoded-submenu">
            ...
            <li class="<?php echo e(Request::is('admin/fees-student') ? 'active' : ''); ?>">
                <a href="<?php echo e(route('admin.fees-student.index')); ?>" class=""><?php echo e(trans_choice('module_fees_due', 1)); ?></a>
            </li>
            <?php endif; ?>

            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('fees-student-quick-assign')): ?>
            <li class="<?php echo e(Request::is('admin/fees-student-quick-assign*') ? 'active' : ''); ?>">
                <a href="<?php echo e(route('admin.fees-student.quick.assign')); ?>" class=""><?php echo e(trans_choice('module_fees_quick_assign', 1)); ?></a>
            </li>
            <?php endif; ?>

            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('fees-student-quick-received')): ?>
            <li class="<?php echo e(Request::is('admin/fees-student-quick-received*') ? 'active' : ''); ?>">
                <a href="<?php echo e(route('admin.fees-student.quick.received')); ?>" class=""><?php echo e(trans_choice('module_fees_quick_received', 1)); ?></a>
            </li>
            <?php endif; ?>

            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('fees-student-multi-assign')): ?>
            <li class="<?php echo e(Request::is('admin/fees-student/assign-multiple*') ? 'active' : ''); ?>">
                <a href="<?php echo e(route('admin.fees-student.assign-multiple')); ?>" class="">Assign Multiple Categogy</a>
            </li>
            <?php endif; ?>

            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['fees-student-report', 'fees-student-print'])): ?>
            <li class="<?php echo e(Request::is('admin/fees-student-report*') ? 'active' : ''); ?>">
                <a href="<?php echo e(route('admin.fees-student.report')); ?>" class=""><?php echo e(trans_choice('module_fees_report', 2)); ?></a>
            </li>
            <?php endif; ?>
        </ul>
    </li>
    ...
    <li class="<?php echo e(Request::is('admin/fees-master/create*') ? 'active' : ''); ?>">
        <a href="<?php echo e(route('admin.fees-master.create')); ?>" class=""><?php echo e(trans_choice('module_fees_master', 2)); ?></a>
    </li>
    <?php endif; ?>

    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['fees-master-view'])): ?>
    <li class="<?php echo e(Request::is('admin/fees-master') ? 'active' : ''); ?>">
        <a href="<?php echo e(route('admin.fees-master.index')); ?>" class=""><?php echo e(trans_choice('module_fees_master_history', 2)); ?></a>
    </li>
    <?php endif; ?>

    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['fees-category-view', 'fees-category-create'])): ?>
    <li class="<?php echo e(Request::is('admin/fees-category*') ? 'active' : ''); ?>">
        <a href="<?php echo e(route('admin.fees-category.index')); ?>" class=""><?php echo e(trans_choice('module_fees_category', 2)); ?></a>
    </li>
    <?php endif; ?>

    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['fees-discount-view', 'fees-discount-create'])): ?>
    <li class="<?php echo e(Request::is('admin/fees-discount*') ? 'active' : ''); ?>">
        <a href="<?php echo e(route('admin.fees-discount.index')); ?>" class=""><?php echo e(trans_choice('module_fees_discount', 2)); ?></a>
    </li>
    <?php endif; ?>

    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['fees-fine-view', 'fees-fine-create'])): ?>
    <li class="<?php echo e(Request::is('admin/fees-fine*') ? 'active' : ''); ?>">
        <a href="<?php echo e(route('admin.fees-fine.index')); ?>" class=""><?php echo e(trans_choice('module_fees_fine', 2)); ?></a>
    </li>
    <?php endif; ?>
    ...
    <li class="nav-item pcoded-hasmenu <?php echo e(Request::is('admin/fees-receipt*') ? 'pcoded-trigger active' : ''); ?>">
        ...
        <ul class="pcoded-submenu">
            ...
            <li class="<?php echo e(Request::is('admin/fees-receipt*') ? 'active' : ''); ?>">
                <a href="<?php echo e(route('admin.fees-receipt.index')); ?>" class=""><?php echo e(trans_choice('module_fees_receipt_setting', 1)); ?></a>
            </li>
            <?php endif; ?>
        </ul>
    </li>
...
</script><?php /**PATH C:\Users\User\Desktop\college\resources\views/admin/layouts/inc/sidebar.blade.php ENDPATH**/ ?>