                    ...
                    <div class="card-block">
                        ...
                        <div class="table-responsive">
                            <table id="report-table" class="display table nowrap table-striped table-hover" style="width:100%">
                                ...
                                <caption><?php echo e($row->studentEnroll->student->student_id ?? ''); ?> - <?php echo e($row->studentEnroll->student->first_name ?? ''); ?> <?php echo e($row->studentEnroll->student->last_name ?? ''); ?></caption>
                            </table>
                        </div>
                        <?php endif; ?>
                        <!-- [ Data table ] end -->
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\User\Desktop\college\resources\views\admin\report\student-fees.blade.php ENDPATH**/ ?>