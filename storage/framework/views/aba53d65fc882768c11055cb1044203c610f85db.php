                                ...
                                <div class="card-body text-success">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div>
                                            ...
                                            <h2 class="mb-0"><?php echo e($clearedStudents); ?></h2>
                                        </div>
                                        <i class="fas fa-check-circle fa-3x opacity-1"></i>
                                    </div>
                                    <div class="mt-2">
                                        <a href="<?php echo e(route($route.'.report')); ?>?status=paid" class="btn btn-sm btn-outline-success">View Report</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="card-body text-warning">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div>
                                            ...
                                            <h2 class="mb-0"><?php echo e($partialStudents); ?></h2>
                                        </div>
                                        <i class="fas fa-exclamation-triangle fa-3x opacity-1"></i>
                                    </div>
                                    <div class="mt-2">
                                        <a href="<?php echo e(route($route.'.report')); ?>?status=partial" class="btn btn-sm btn-outline-warning">View Report</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="card-body text-danger">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div>
                                            ...
                                            <h2 class="mb-0"><?php echo e($pendingStudents); ?></h2>
                                        </div>
                                        <i class="fas fa-times-circle fa-3x opacity-1"></i>
                                    </div>
                                    <div class="mt-2">
                                        <a href="<?php echo e(route($route.'.report')); ?>?status=pending" class="btn btn-sm btn-outline-danger">View Report</a>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="card shadow-sm">
                <div class="card-header bg-white border-bottom">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div class="col-md-6">
                            <form action="<?php echo e(route($route.'.search')); ?>" method="GET">
                        ...
                        <div class="card shadow-sm mb-4">
                            <div class="card-header bg-white d-flex justify-content-between align-items-center">
                                <h4 class="mb-0">
                                    ...
                                    Student Details For <?php echo e($student->first_name . ' ' . $student->last_name); ?>.
                                </h4>
                                <div>
                                    <?php
                                    ...
                                    ?>
                                    <span class="badge bg-<?php echo e($status === 'paid' ? 'success' : 
                                        ($status === 'partial' ? 'warning' : 'danger')); ?> fs-6">
                                ...
                                <div class="row mb-4">
                                    <div class="col-md-3">
                                        <div class="text-center">
                                            <img src="<?php echo e(asset('dashboard/images/user/avatar-2.jpg')); ?>" alt="Student Photo" class="img-thumbnail mb-3" style="max-height: 200px;">
                                            <h5>Student ID: <?php echo e($student->student_id); ?></h5>
                                        </div>
                                    </div>
                                    <div class="col-md-9">
                                        <div class="row">
                                            <div class="col-md-4">
                                                <p><strong>Student Name:</strong> <?php echo e($student->first_name . ' ' . $student->last_name); ?></p>
                                                <p><strong>Course:</strong> <?php echo e($program->title); ?></p>
                                            ...
                                            <div class="col-md-4">
                                                <p><strong>Total Invoiced:</strong> Ksh  <?php echo e(number_format($invoices->sum('total_fee'), 2)); ?></p>
                                                <p><strong>Total Paid:</strong> Ksh <?php echo e(number_format($invoices->sum('amount_paid'), 2)); ?></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="tab-content p-3 border border-top-0 rounded-bottom" id="studentTabsContent">
                                                    ...
                                                    <table class="table table-hover">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>Ksh <?php echo e(number_format($invoice->amount_due, 2)); ?></td>
                                                                <td>
                                                                    <span class="badge bg-<?php echo e($invoice->payment_status === 'paid' ? 'success' : 
                                                                        ($invoice->payment_status === 'partial' ? 'warning' : 'danger')); ?>">
                                                                        <?php echo e(strtoupper($invoice->payment_status)); ?>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <a href="<?php echo e(route($route.'.clear', $invoice->id)); ?>" class="btn btn-sm btn-outline-success" title="Mark as Paid">
                                            ...
                                            <div class="tab-pane fade" id="history" role="tabpanel">
                                                ...
                                                <div class="table-responsive">
                                                    <table class="table table-hover table-striped">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                <td><?php echo e($invoice->invoice_no); ?></td>
                                                                <td><?php echo e($invoice->assign_date->format('d M Y')); ?></td>
                                                ...
                                                <div class="d-flex justify-content-between align-items-center mt-3">
                                                    <div>
                                                        Showing <?php echo e($allInvoices->firstItem()); ?> to <?php echo e($allInvoices->lastItem()); ?> of <?php echo e($allInvoices->total()); ?> entries
                                                    </div>
                                                    <div>
                                                        <?php echo e($allInvoices->links()); ?>
                                                ...
                                                <div class="alert alert-info">
                                                    ...
                                                    <a href="<?php echo e(route($route.'.history', $student->student_id)); ?>" class="alert-link">
                                            ...
                                            <div class="tab-pane fade" id="notify" role="tabpanel">
                                                <form action="<?php echo e(route($route.'.notify', $student->student_id)); ?>" method="POST">
                                                    <?php echo csrf_field(); ?>
                                                    <div class="mb-3">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <textarea class="form-control" id="notificationMessage" name="message" rows="5" required>Dear <?php echo e($student->first_name . ' ' . $student->last_name); ?>,
Your current outstanding balance is Ksh <?php echo e(number_format($invoices->sum('amount_due'), 2)); ?> from <?php echo e($invoices->count()); ?> invoice(s).
                ...
                <div class="card-body">
                    <div class="row text-center">
                        <div class="col-md-3 mb-3">
                            <a href="<?php echo e(route($route.'.report')); ?>" class="btn btn-outline-primary w-100 py-3">
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\Dapin-CMS-main\resources\views/admin/fee-clearance/index.blade.php ENDPATH**/ ?>