    ...
    <div class="page-wrapper">
        ...
        <div class="row">
            <div class="card-block">
                <form class="needs-validation" novalidate method="get" action="<?php echo e(route('admin.sms.search')); ?>">
                    <?php echo csrf_field(); ?>
                    <div class="row gx-2">
                        ...
                        <div class="form-group col-md-2 d-flex align-items-end">
                            ...
                            <a href="<?php echo e(route('admin.sms.index')); ?>" class="btn btn-secondary btn-sm"><i class="fas fa-sync-alt"></i> <?php echo e(__('')); ?></a>
                        </div>
                    </div>
                </form>
            </div>
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $filteredMessages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $message): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td>
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check($access.'-view')): ?> <a href="<?php echo e(route('admin.sms.show', $message->id)); ?>" 
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\User\Desktop\cms\Dapin-CMS\resources\views/admin/sms/index.blade.php ENDPATH**/ ?>