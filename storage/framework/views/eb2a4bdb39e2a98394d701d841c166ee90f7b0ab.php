                ...
                <div class="card user-card user-card-1">
                        ...
                        <div class="media user-about-block align-items-center mt-0 mb-3">
                            <div class="position-relative d-inline-block">
                                <?php if(is_file('uploads/'.$path.'/'.$row->photo)): ?>
                                    <img src="<?php echo e(asset('uploads/'.$path.'/'.$row->photo)); ?>" class="img-radius img-fluid wid-80" alt="<?php echo e(__('Photo')); ?>" onerror="this.src='<?php echo e(asset('dashboard/images/user/avatar-2.jpg')); ?>';">
                                <?php else: ?>
                                    <img src="<?php echo e(asset('dashboard/images/user/avatar-2.jpg')); ?>" class="img-radius img-fluid wid-80" alt="<?php echo e(__('Photo')); ?>">
                                <?php endif; ?>
                    ...
                    <ul class="list-group list-group-flush">
                        <li class="list-group-item">
                            <span class="f-w-500"><i class="far fa-envelope m-r-10"></i><?php echo e(__('Email')); ?> : </span>
                            <span class="float-end"><?php echo e($row->email); ?></span>
                        </li>
                        <li class="list-group-item">
                            <span class="f-w-500"><i class="fas fa-phone-alt m-r-10"></i><?php echo e(__('Phone')); ?> : </span>
                            <span class="float-end"><?php echo e($row->phone); ?></span>
                        </li>
                        <li class="list-group-item">
                            <span class="f-w-500"><i class="fas fa-graduation-cap m-r-10"></i><?php echo e(__('Program')); ?> : </span>
                            <span class="float-end"><?php echo e($row->program->title ?? ''); ?></span>
                        </li>
                        <li class="list-group-item">
                            <span class="f-w-500"><i class="far fa-calendar-alt m-r-10"></i><?php echo e(__('Apply Date')); ?> : </span>
                        ...
                        <li class="list-group-item border-bottom-0">
                            <span class="f-w-500"><i class="far fa-question-circle m-r-10"></i><?php echo e(__('Status')); ?> : </span>
                            <span class="float-end">
                                <?php if( $row->status == 1 ): ?>
                                    <span class="badge badge-pill badge-primary"><?php echo e(__('Pending')); ?></span>
                                <?php elseif( $row->status == 2 ): ?>
                                    <span class="badge badge-pill badge-success"><?php echo e(__('Approved')); ?></span>
                                <?php else: ?>
                                    <span class="badge badge-pill badge-danger"><?php echo e(__('Rejected')); ?></span>
                                <?php endif; ?>
                            </span>
                        </li>
                    </ul>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <fieldset class="row gx-2 scheduler-border">
                                        <legend><?php echo e(__('Present Address')); ?></legend>
                                ...
                                <div class="col-md-4">
                                    <?php if(!empty($row->school_name)): ?>
                                        <fieldset class="row gx-2 scheduler-border">
                                            <legend><?php echo e(__('School Information')); ?></legend>
                                            <p><mark class="text-primary"><?php echo e(__('School Name')); ?>:</mark> <?php echo e($row->school_name); ?></p><hr/>
                                            <p><mark class="text-primary"><?php echo e(__('Exam ID')); ?>:</mark> <?php echo e($row->school_exam_id); ?></p><hr/>
                                        </fieldset>
                                    <?php endif; ?>
                                </div>
                            </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\User\Desktop\cms\Dapin-CMS\resources\views/admin/application/show.blade.php ENDPATH**/ ?>