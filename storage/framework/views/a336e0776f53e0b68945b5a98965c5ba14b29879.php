...
<div class="template-container printable" style="border-image: url('<?php echo e(asset('uploads/'.$path.'/'.$certificate->template->background)); ?>') 30 stretch; width: <?php echo e($certificate->template->width); ?>; height: <?php echo e($certificate->template->height); ?>;">
...
</html><?php /**PATH C:\Users\User\Desktop\business\backup\Dapin\Dapin\resources\views\admin\certificate\print.blade.php ENDPATH**/ ?>