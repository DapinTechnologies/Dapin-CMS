    ...
    <table class="table-no-border">
        <tbody>
            <tr class="meta-data">
                ...
                <td class="value">: <?php echo e($print->prefix ?? ''); ?><?php echo e($row->library_id); ?></td>
            </tr>
            <tr class="meta-data">
...
</html><?php /**PATH C:\Users\User\Desktop\college\resources\views\admin\library-outsider\card.blade.php ENDPATH**/ ?>