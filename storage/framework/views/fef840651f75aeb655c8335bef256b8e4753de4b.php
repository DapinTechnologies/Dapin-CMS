        ...
        <div class="container">
            <div class="row align-items-center text-center">
                <div class="col-12">
                    ...
                    <h1 class="fw-bold material-page-title mb-2" style="color: #000 !important;"><?php echo e($material->title); ?></h1>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb justify-content-center mb-0"> 
                            <li class="breadcrumb-item"><a href="<?php echo e(route('home')); ?>" class="breadcrumb-link" style="color: #555 !important;"><?php echo e(__('navbar_home')); ?></a></li>
                            <li class="breadcrumb-item"><a href="" class="breadcrumb-link" style="color: #555 !important;"><?php echo e(__('Library')); ?></a></li>
                            <li class="breadcrumb-item active" aria-current="page" style="color: #000 !important; font-weight: 600;"><?php echo e($material->title); ?></li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div class="row justify-content-center"> 
                <div class="col-md-10 col-lg-8"> 
                    ...
                    <div class="material-card shadow-lg rounded p-5" style="background: #fff;">
                        ...
                        <h3 class="mb-3" style="color: #000 !important; font-size: 1.8rem; font-weight: 700;"><?php echo e($material->title); ?></h3>
                        <hr class="mb-4"> 

                        <div class="material-info">
                            <ul class="list-unstyled mb-4" style="color: #333 !important;"> 
                                <li><strong style="color: #000 !important;"><?php echo e(__('Author')); ?>:</strong> <span><?php echo e($material->author); ?></span></li>
                                <li><strong style="color: #000 !important;"><?php echo e(__('Publisher')); ?>:</strong> <span><?php echo e($material->publisher); ?></span></li>
                                <li><strong style="color: #000 !important;"><?php echo e(__('Language')); ?>:</strong> <span><?php echo e($material->language); ?></span></li>
                                <li><strong style="color: #000 !important;"><?php echo e(__('Edition')); ?>:</strong> <span><?php echo e($material->edition); ?></span></li>
                                <li><strong style="color: #000 !important;"><?php echo e(__('ISBN')); ?>:</strong> <span><?php echo e($material->isbn); ?></span></li>
                                
                                <li style="border-bottom: none;"><strong style="color: #000 !important;"><?php echo e(__('Description')); ?>:</strong></li>
                                <p style="color: #333; line-height: 1.6; margin-top: 5px;"><?php echo e($material->description); ?></p>

                                <li style="margin-top: 15px;"><strong style="color: #000 !important;"><?php echo e(__('Created At')); ?>:</strong> <span><?php echo e(date('d F, Y', strtotime($material->created_at))); ?></span></li>
                                <li>
                                    <strong style="color: #000 !important;"><?php echo e(__('Status')); ?>:</strong> 
                                    <?php if($material->is_public): ?>
                                        <span class="badge bg-success" style="color: #fff !important; background-color: #28a745 !important;"><?php echo e(__('Public')); ?></span>
                                    <?php else: ?>
                                        <?php if(auth()->guard()->check()): ?>
                                            <span class="badge bg-warning" style="color: #000 !important; background-color: #ffc107 !important;"><?php echo e(__('Private')); ?></span>
                                        <?php else: ?>
                                            <span class="badge bg-warning" style="color: #000 !important; background-color: #ffc107 !important;"><?php echo e(__('Private')); ?></span>
                                        <?php endif; ?>
                                    <?php endif; ?>
                        ...
                        <?php if($material->is_downloadable): ?>
                            <div class="text-center mt-5"> 
                                <a href="<?php echo e(asset($material->file_path)); ?>" class="btn btn-primary btn-lg px-4 py-2" style="font-size: 1rem; color: #fff !important; border-radius: 50px;" download>
                                    <i class="fas fa-download me-2"></i> <?php echo e(__('Download File')); ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('web.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\User\Desktop\cms\Dapin-CMS\resources\views/web/file/book.blade.php ENDPATH**/ ?>