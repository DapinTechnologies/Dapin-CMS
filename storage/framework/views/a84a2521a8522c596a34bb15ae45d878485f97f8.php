<div class="form-group col-md-3">
  ...
  <select class="form-control faculty" name="faculty" id="faculty">
    ...
    <option value="<?php echo e($faculty->id); ?>" <?php if( isset($selected_faculty) && $selected_faculty == $faculty->id): ?> selected <?php endif; ?>>
...
</script><?php /**PATH C:\Users\User\Desktop\college\resources\views\common\inc\student_search_filter.blade.php ENDPATH**/ ?>