...
use App\Http\Controllers\PeseStkPsh;
...
Route::get('/sms/test', [SmsController::class, 'sendTestSms'])->name('sms.test');
...
Route::get('/fees/invoice', [FeesStudentController::class, 'invoice'])->name('fees.invoice');



Route::prefix('admin')->middleware(['auth', 'permission:fees-student-quick-assign'])->group(function () {
    Route::get('fees-student/assign-multiple', [FeesStudentController::class, 'assignMultiple'])->name('admin.fees-student.assign-multiple');
    Route::post('fees-student/assign-multiple', [FeesStudentController::class, 'storeMultiple'])->name('admin.fees-student.store-multiple');
    Route::get('ajax/search-students', [FeesStudentController::class, 'ajaxSearchStudents'])->name('admin.ajax.search-students');
Route::get('admin/fees-student/assigned-history', [FeesStudentController::class, 'assignedFeesHistory'])->name('admin.fees-student.assigned-history');
Route::get('admin/fees-summary', [FeesStudentController::class, 'assignedFeesSummary'])->name('admin.fees-summary');
...
Route::get('/paymentprocess/{id}', [PesaController::class, 'process'])->name('paymentprocess');
   ...
   Route::post('/initiatepush',[PesaController::class,'initiateStkPush'])->name('initiatepush');
