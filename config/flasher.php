...
return array(
    ...
    */
    ...
    'default' => 'toastr', // You can set the default notification driver to 'toastr' or others supported.
    'drivers' => [
        'toastr' => [
            'theme' => 'default', // You can change this to 'bootstrap', 'material', etc., based on your design preference
            'options' => [
                'closeButton' => true,
                'progressBar' => true,
                'positionClass' => 'toast-top-right', // Toast position, you can change this based on your preference
            ]
        ],
    ],
